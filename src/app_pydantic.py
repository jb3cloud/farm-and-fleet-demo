...
from plugins.analytics.statistical_analytics_plugin import StatisticalAnalyticsPlugin
...
class AppDependencies:
    ...
    def __init__(
        ...
        analytics_client: StatisticalAnalyticsPlugin | None = None,
    ...
    def analyze_feedback_trends(  # pyright: ignore[reportUnusedFunction]
        ...
        with cl.Step(
            ...
            try:
                ...
                plugin = StatisticalAnalyticsPlugin()
                result = plugin.analyze_feedback_trends(
    ...
    def assess_churn_risk_indicators(  # pyright: ignore[reportUnusedFunction]
        ...
        with cl.Step(
            ...
            try:
                ...
                plugin = StatisticalAnalyticsPlugin()
                result = plugin.assess_churn_risk_indicators(
                    feedback_data, risk_factors, time_window, max_results, detail_level
                )
    ...
    def predict_trend_trajectory(  # pyright: ignore[reportUnusedFunction]
        ...
        with cl.Step(
            ...
            try:
                ...
                plugin = StatisticalAnalyticsPlugin()
                result = plugin.predict_trend_trajectory(
                    historical_data,
                    forecast_periods,
                    prediction_metric,
                    confidence_level,
    ...
    def detect_trend_anomalies(  # pyright: ignore[reportUnusedFunction]
        ...
        with cl.Step(
            ...
            try:
                ...
                plugin = StatisticalAnalyticsPlugin()
                result = plugin.detect_trend_anomalies(
                    data_series,
                    detection_method,
                    sensitivity,
                    max_results,
    ...
    def compare_time_periods(  # pyright: ignore[reportUnusedFunction]
        ...
        with cl.Step(
            ...
            try:
                ...
                plugin = StatisticalAnalyticsPlugin()
                result = plugin.compare_time_periods(
                    period1_data,
                    period2_data,
                    comparison_metric,
                    test_type,
...
def create_dependencies() -> AppDependencies:
    ...
    try:
        analytics_client = StatisticalAnalyticsPlugin()
        logger.info("Analytics client initialized successfully")
    except Exception as e:
        logger.warning(f"Failed to initialize analytics client: {str(e)}")
    ...
    return AppDependencies(
        ...
        analytics_available=analytics_client is not None,
    )
